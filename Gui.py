...
def depo():
    ...
    om1.grid(column=1, row=0, sticky=W+E, padx=5, pady=5)
    
    dep_sr_lab = Label(d, text="Source")
    dep_sr_lab.grid(column=0, row=1, sticky=W+E, padx=5, pady=5)
    ...
    om1.grid(column=1, row=1, sticky=W+E, padx=5, pady=5)
    
    lab_amt = Label(d, text = "Amount")
    lab_amt.grid(column=0, row=2, sticky=W+E, padx=5, pady=5)
    lab_amt.configure(bg='#49A')

    text_amt = StringVar(d)
    amt_hm = Entry(d, textvariable = text_amt)
    amt_hm.grid(column=1, row=2, sticky=W+E, padx=5, pady=5)

    lab_rem = Label(d, text ="Description")
    lab_rem.grid(column=0, row=3, sticky=W+E, padx=5, pady=5)
    lab_rem.configure(bg='#49A')

    text_rem = StringVar(d)
    rem_hm = Entry(d, textvariable = text_rem)
    rem_hm.grid(column=1, row=3, sticky=W+E, padx=5, pady=5)
